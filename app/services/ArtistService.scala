...
object ArtistService {
  ...
  val eric = Artist(5, "Eric Clapton", "Blues", "https://www.rockhall.com/sites/default/files/styles/header_image_portrait/public/ericclapton_001-2.jpg?itok=-nceAiaG")
